        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-7" data-aos="fade-right">
                <div class="section-head">
                    ...
                    <p class="section-subtitle">MindScan is a focused research platform that maps social media habits to
                        mental wellness indicators. It is designed to support academic analysis while keeping the
                        experience calming, minimal, and privacy-first.</p>
                </div>
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        <div class="glass-card">
                            <h6>Purpose</h6>
                            <p>Provide a structured way to observe how digital behavior shapes mood, sleep, and focus.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="glass-card">
                            ...
                            <p>Students and young adults face growing online pressure. MindScan translates that impact
                                into measurable, actionable insights.</p>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="glass-card">
                            ...
                            <ol class="key-findings">
                                <li>Excessive usage (4+ hours/day) significantly increases distraction and reduces
                                    focus.</li>
                                <li>Emotional instability is strongly linked with increased screen time, especially
                                    before sleep.</li>
                                <li>Sleep disturbances are 2.3x more common among heavy social media users.</li>
                                <li>Productivity decline of 40-60% reported by users who engage in aimless scrolling.
                                </li>
                                <li>Social comparison features drive the highest rates of anxiety and low self-esteem.
                                </li>
                            </ol>
                        </div>
                    </div>
...
<section class="section objectives-section" id="objectives">
    <div class="container objectives-shell">
        <div class="objectives-header text-center">
            ...
            <p class="objectives-subtitle">Our study is guided by six core objectives designed to comprehensively
                understand the social media-mental health relationship.</p>
        </div>
        ...
        <div class="objectives-grid">
            <article class="objectives-card">
                ...
                <p>Quantify the psychological impact of social media usage patterns on anxiety, depression, stress, and
                    emotional well-being using validated metrics.</p>
            </article>
            <article class="objectives-card">
                ...
                <p>Analyze user behavior patterns including usage frequency, duration, platform preferences, and their
                    correlation with behavioral changes.</p>
            </article>
            <article class="objectives-card">
                ...
                <p>Apply NLP techniques to analyze open-ended survey responses, identifying emotional patterns and
                    sentiment distribution across user groups.</p>
            </article>
            <article class="objectives-card">
                ...
                <p>Develop machine learning models to predict mental health risk levels based on social media usage
                    patterns and demographic factors.</p>
            </article>
            <article class="objectives-card">
                ...
                <p>Create evidence-based guidelines and assessment tools for promoting healthier digital habits and
            ...
            <article class="objectives-card">
                ...
                <p>Build an interactive platform that educates users about the effects of social media and provides
                    tools for self-assessment and improvement.</p>
            </article>
        </div>
    </div>
</section>
                                    ...
                                    <article class="doc-card">
                                        ...
                                        <?php if (!empty($doc['file_path'])): ?>
                                            <div class="doc-actions">
                                                <a class="btn btn-sm btn-outline-light" href="<?php echo e($doc['file_path']); ?>"
                                                    target="_blank" rel="noopener">View</a>
                                                <a class="btn btn-sm btn-gradient" href="<?php echo e($doc['file_path']); ?>"
                                                    download>Download</a>
                                            </div>
                                        <?php else: ?>
...
<section class="section" id="screening">
    <div class="container">
        <div class="section-head">
            ...
            <p class="section-subtitle">Answer 10 short questions to receive a simple risk level. This is an educational
                screening and not a clinical diagnosis.</p>
        </div>
        <div class="glass-panel screening-shell" data-aos="fade-up">
            ...
            <div class="screening-card" id="screening-card">
                ...
                <div class="screening-options" id="screening-options" role="radiogroup" aria-label="Response options">
                </div>
...
<section class="section" id="mood">
    <div class="container">
        <div class="section-head">
            ...
            <p class="section-subtitle">Log your mood daily and visualize trends over time. All mood data is stored
                locally in your browser and never uploaded.</p>
        </div>
        <div class="row g-4">
            <div class="col-lg-5" data-aos="fade-right">
                <div class="glass-panel mood-shell">
                    ...
                    <button class="btn btn-outline-light btn-sm" type="button" id="mood-clear">Clear mood
                        history</button>
                </div>
            </div>
